...
public class AmazonKinesisRecordProducerSample {
    ...
    public static void main(String[] args) throws Exception {
    	AmazonKinesisRecordProducerSample test=new AmazonKinesisRecordProducerSample();
    	test.run();
    }

    private void produceData(int counter) throws InterruptedException{
    	String myStreamName = AmazonKinesisApplicationSample.SAMPLE_APPLICATION_STREAM_NAME;
